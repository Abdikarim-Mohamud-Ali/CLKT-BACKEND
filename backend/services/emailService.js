...
async function sendPasswordResetEmail(name, email, code) {
    ...
    const result = await resend.emails.send({
        ...
        subject: "Reset your CLKT password",
...
We received a request to reset your CLKT password.
...
This password reset code expires after
<strong>10 minutes</strong>.
...
Your password will not be changed unless
someone enters the verification code.
...
reset was requested for this account.
